...
parcelRequire=function(modules,cache,entry,globalName){// Save the require from previous bundle to this closure if any
var previousRequire=typeof parcelRequire==='function'&&parcelRequire;var nodeRequire=typeof require==='function'&&require;function newRequire(name,jumped){if(!cache[name]){if(!modules[name]){// if we cannot find the module within our internal map or
// cache jump to the current global require ie. the last bundle
// that was added to the page.
var currentRequire=typeof parcelRequire==='function'&&parcelRequire;if(!jumped&&currentRequire){return currentRequire(name,true);}// If there are other bundles on this page the require from the
// previous one is saved to 'previousRequire'. Repeat this as
// many times as there are bundles until the module is found or
// we exhaust the require chain.
if(previousRequire){return previousRequire(name,true);}// Try the node require function if it exists.
if(nodeRequire&&typeof name==='string'){return nodeRequire(name);}var err=new Error('Cannot find module \''+name+'\'');err.code='MODULE_NOT_FOUND';throw err;}localRequire.resolve=resolve;localRequire.cache={};var module=cache[name]=new newRequire.Module(name);modules[name][0].call(module.exports,localRequire,module,module.exports,this);}return cache[name].exports;function localRequire(x){return newRequire(localRequire.resolve(x));}function resolve(x){return modules[name][1][x]||x;}}function Module(moduleName){this.id=moduleName;this.bundle=newRequire;this.exports={};}newRequire.isParcelRequire=true;newRequire.Module=Module;newRequire.modules=modules;newRequire.cache=cache;newRequire.parent=previousRequire;newRequire.register=function(id,exports){modules[id]=[function(require,module){module.exports=exports;},{}];};var error;for(var i=0;i<entry.length;i++){try{newRequire(entry[i]);}catch(e){// Save first error but execute all entries
if(!error){error=e;}}}if(entry.length){// Expose entry point to Node, AMD or browser globals
...
}else if(typeof define==="function"&&define.amd){define(function(){return mainExports;});// <script>
}else if(globalName){this[globalName]=mainExports;}}// Override the current require with this new one
parcelRequire=newRequire;if(error){// throw error from earlier, _after updating parcelRequire_
throw error;}return newRequire;}({"node_modules/object-assign/index.js":[function(require,module,exports){/*
object-assign
(c) Sindre Sorhus
@license MIT
...
return false;}}module.exports=shouldUseNative()?Object.assign:function(target,source){var from;var to=toObject(target);var symbols;for(var s=1;s<arguments.length;s++){from=Object(arguments[s]);for(var key in from){if(hasOwnProperty.call(from,key)){to[key]=from[key];}}if(getOwnPropertySymbols){symbols=getOwnPropertySymbols(from);for(var i=0;i<symbols.length;i++){if(propIsEnumerable.call(from,symbols[i])){to[symbols[i]]=from[symbols[i]];}}}}return to;};},{}],"node_modules/react/cjs/react.development.js":[function(require,module,exports){/** @license React v17.0.1
 ...
 */'use strict';if("development"!=="production"){(function(){'use strict';var _assign=require('object-assign');// TODO: this is special because it gets imported during build.
...
Function.prototype.apply.call(console[level],console,argsWithFormat);}}var didWarnStateUpdateForUnmountedComponent={};function warnNoop(publicInstance,callerName){{var _constructor=publicInstance.constructor;var componentName=_constructor&&(_constructor.displayName||_constructor.name)||'ReactClass';var warningKey=componentName+"."+callerName;if(didWarnStateUpdateForUnmountedComponent[warningKey]){return;}error("Can't call %s on a component that is not yet mounted. "+'This is a no-op, but it might indicate a bug in your application. '+'Instead, assign to `this.state` directly or define a `state = {};` '+'class property with the desired state in the %s component.',callerName,componentName);didWarnStateUpdateForUnmountedComponent[warningKey]=true;}}/**
     ...
     */var ReactNoopUpdateQueue={/**
       ...
       * @internal
       */enqueueSetState:function enqueueSetState(publicInstance,partialState,callback,callerName){warnNoop(publicInstance,'setState');}};var emptyObject={};{Object.freeze(emptyObject);}/**
...
return null;}{if(typeof type.tag==='number'){error('Received an unexpected object in getComponentName(). '+'This is likely a bug in React. Please file an issue.');}}if(typeof type==='function'){return type.displayName||type.name||null;}if(typeof type==='string'){return type;}switch(type){case exports.Fragment:return'Fragment';case REACT_PORTAL_TYPE:return'Portal';case exports.Profiler:return'Profiler';case exports.StrictMode:return'StrictMode';case exports.Suspense:return'Suspense';case REACT_SUSPENSE_LIST_TYPE:return'SuspenseList';}if(_typeof(type)==='object'){switch(type.$$typeof){case REACT_CONTEXT_TYPE:var context=type;return getContextName(context)+'.Consumer';case REACT_PROVIDER_TYPE:var provider=type;return getContextName(provider._context)+'.Provider';case REACT_FORWARD_REF_TYPE:return getWrappedName(type,type.render,'ForwardRef');case REACT_MEMO_TYPE:return getComponentName(type.type);case REACT_BLOCK_TYPE:return getComponentName(type._render);case REACT_LAZY_TYPE:{var lazyComponent=type;var payload=lazyComponent._payload;var init=lazyComponent._init;try{return getComponentName(init(payload));}catch(x){return null;}}}}return null;}var hasOwnProperty=Object.prototype.hasOwnProperty;var RESERVED_PROPS={key:true,ref:true,__self:true,__source:true};var specialPropKeyWarningShown,specialPropRefWarningShown,didWarnAboutStringRefs;{didWarnAboutStringRefs={};}function hasValidRef(config){{if(hasOwnProperty.call(config,'ref')){var getter=Object.getOwnPropertyDescriptor(config,'ref').get;if(getter&&getter.isReactWarning){return false;}}}return config.ref!==undefined;}function hasValidKey(config){{if(hasOwnProperty.call(config,'key')){var getter=Object.getOwnPropertyDescriptor(config,'key').get;if(getter&&getter.isReactWarning){return false;}}}return config.key!==undefined;}function defineKeyPropWarningGetter(props,displayName){var warnAboutAccessingKey=function warnAboutAccessingKey(){{if(!specialPropKeyWarningShown){specialPropKeyWarningShown=true;error('%s: `key` is not a prop. Trying to access it will result '+'in `undefined` being returned. If you need to access the same '+'value within the child component, you should pass it as a different '+'prop. (https://reactjs.org/link/special-props)',displayName);}}};warnAboutAccessingKey.isReactWarning=true;Object.defineProperty(props,'key',{get:warnAboutAccessingKey,configurable:true});}function defineRefPropWarningGetter(props,displayName){var warnAboutAccessingRef=function warnAboutAccessingRef(){{if(!specialPropRefWarningShown){specialPropRefWarningShown=true;error('%s: `ref` is not a prop. Trying to access it will result '+'in `undefined` being returned. If you need to access the same '+'value within the child component, you should pass it as a different '+'prop. (https://reactjs.org/link/special-props)',displayName);}}};warnAboutAccessingRef.isReactWarning=true;Object.defineProperty(props,'ref',{get:warnAboutAccessingRef,configurable:true});}function warnIfStringRefCannotBeAutoConverted(config){{if(typeof config.ref==='string'&&ReactCurrentOwner.current&&config.__self&&ReactCurrentOwner.current.stateNode!==config.__self){var componentName=getComponentName(ReactCurrentOwner.current.type);if(!didWarnAboutStringRefs[componentName]){error('Component "%s" contains the string ref "%s". '+'Support for string refs will be removed in a future major release. '+'This case cannot be automatically converted to an arrow function. '+'We ask you to manually fix this case by using useRef() or createRef() instead. '+'Learn more about using refs safely here: '+'https://reactjs.org/link/strict-mode-string-ref',componentName,config.ref);didWarnAboutStringRefs[componentName]=true;}}}}/**
     ...
     * @internal
     */var ReactElement=function ReactElement(type,key,ref,self,source,owner,props){var element={// This tag allows us to uniquely identify this as a React Element
...
var childrenLength=arguments.length-2;if(childrenLength===1){props.children=children;}else if(childrenLength>1){var childArray=Array(childrenLength);for(var i=0;i<childrenLength;i++){childArray[i]=arguments[i+2];}props.children=childArray;}return ReactElement(element.type,key,ref,self,source,owner,props);}/**
     ...
     * @final
     */function isValidElement(object){return _typeof(object)==='object'&&object!==null&&object.$$typeof===REACT_ELEMENT_TYPE;}var SEPARATOR='.';var SUBSEPARATOR=':';/**
...
if(_typeof(element)==='object'&&element!==null&&element.key!=null){// Explicit key
return escape(''+element.key);}// Implicit key determined by the index in the set
return index.toString(36);}function mapIntoArray(children,array,escapedPrefix,nameSoFar,callback){var type=_typeof(children);if(type==='undefined'||type==='boolean'){// All of the above are perceived as null.
...
Object.defineProperties(lazyType,{defaultProps:{configurable:true,get:function get(){return defaultProps;},set:function set(newDefaultProps){error('React.lazy(...): It is not supported to assign `defaultProps` to '+'a lazy component import. Either specify them where the component '+'is defined, or create a wrapping component around it.');defaultProps=newDefaultProps;// Match production behavior more closely:
// $FlowFixMe
Object.defineProperty(lazyType,'defaultProps',{enumerable:true});}},propTypes:{configurable:true,get:function get(){return propTypes;},set:function set(newPropTypes){error('React.lazy(...): It is not supported to assign `propTypes` to '+'a lazy component import. Either specify them where the component '+'is defined, or create a wrapping component around it.');propTypes=newPropTypes;// Match production behavior more closely:
// $FlowFixMe
Object.defineProperty(lazyType,'propTypes',{enumerable:true});}}});}return lazyType;}function forwardRef(render){{if(render!=null&&render.$$typeof===REACT_MEMO_TYPE){error('forwardRef requires a render function but received a `memo` '+'component. Instead of forwardRef(memo(...)), use '+'memo(forwardRef(...)).');}else if(typeof render!=='function'){error('forwardRef requires a render function but was given %s.',render===null?'null':_typeof(render));}else{if(render.length!==0&&render.length!==2){error('forwardRef render functions accept exactly two parameters: props and ref. %s',render.length===1?'Did you forget to use the ref parameter?':'Any additional parameter will be undefined.');}}if(render!=null){if(render.defaultProps!=null||render.propTypes!=null){error('forwardRef render functions do not support propTypes or defaultProps. '+'Did you accidentally pass a React component?');}}}var elementType={$$typeof:REACT_FORWARD_REF_TYPE,render:render};{var ownName;Object.defineProperty(elementType,'displayName',{enumerable:false,configurable:true,get:function get(){return ownName;},set:function set(name){ownName=name;if(render.displayName==null){render.displayName=name;}}});}return elementType;}// Filter certain DOM attributes (e.g. src, href) if their values are empty strings.
...
childOwner=" It was passed a child from "+getComponentName(element._owner.type)+".";}{setCurrentlyValidatingElement$1(element);error('Each child in a list should have a unique "key" prop.'+'%s%s See https://reactjs.org/link/warning-keys for more information.',currentComponentErrorInfo,childOwner);setCurrentlyValidatingElement$1(null);}}/**
     ...
     */function validateChildKeys(node,parentType){if(_typeof(node)!=='object'){return;}if(Array.isArray(node)){for(var i=0;i<node.length;i++){var child=node[i];if(isValidElement(child)){validateExplicitKey(child,parentType);}}}else if(isValidElement(node)){// This element was passed in a valid location.
...
if(iteratorFn!==node.entries){var iterator=iteratorFn.call(node);var step;while(!(step=iterator.next()).done){if(isValidElement(step.value)){validateExplicitKey(step.value,parentType);}}}}}}/**
     ...
     */function validatePropTypes(element){{var type=element.type;if(type===null||type===undefined||typeof type==='string'){return;}var propTypes;if(typeof type==='function'){propTypes=type.propTypes;}else if(_typeof(type)==='object'&&(type.$$typeof===REACT_FORWARD_REF_TYPE||// Note: Memo only checks outer props here.
...
var _callback=null;var _timeoutID=null;var _flushCallback=function _flushCallback(){if(_callback!==null){try{var currentTime=exports.unstable_now();var hasRemainingTime=true;_callback(hasRemainingTime,currentTime);_callback=null;}catch(e){setTimeout(_flushCallback,0);throw e;}}};_requestHostCallback=function requestHostCallback(cb){if(_callback!==null){// Protect against re-entrancy.
setTimeout(_requestHostCallback,0,cb);}else{_callback=cb;setTimeout(_flushCallback,0);}};requestHostTimeout=function requestHostTimeout(cb,ms){_timeoutID=setTimeout(cb,ms);};cancelHostTimeout=function cancelHostTimeout(){clearTimeout(_timeoutID);};exports.unstable_shouldYield=function(){return false;};requestPaint=exports.unstable_forceFrameRate=function(){};}else{// Capture local references to native APIs, in case a polyfill overrides them.
...
var previousPriorityLevel=currentPriorityLevel;currentPriorityLevel=parentPriorityLevel;try{return callback.apply(this,arguments);}finally{currentPriorityLevel=previousPriorityLevel;}};}function unstable_scheduleCallback(priorityLevel,callback,options){var currentTime=exports.unstable_now();var startTime;if(_typeof(options)==='object'&&options!==null){var delay=options.delay;if(typeof delay==='number'&&delay>0){startTime=currentTime+delay;}else{startTime=currentTime;}}else{startTime=currentTime;}var timeout;switch(priorityLevel){case ImmediatePriority:timeout=IMMEDIATE_PRIORITY_TIMEOUT;break;case UserBlockingPriority:timeout=USER_BLOCKING_PRIORITY_TIMEOUT;break;case IdlePriority:timeout=IDLE_PRIORITY_TIMEOUT;break;case LowPriority:timeout=LOW_PRIORITY_TIMEOUT;break;case NormalPriority:default:timeout=NORMAL_PRIORITY_TIMEOUT;break;}var expirationTime=startTime+timeout;var newTask={id:taskIdCounter++,callback:callback,priorityLevel:priorityLevel,startTime:startTime,expirationTime:expirationTime,sortIndex:-1};{newTask.isQueued=false;}if(startTime>currentTime){// This is a delayed task.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */'use strict';if("development"!=="production"){(function(){'use strict';var DEFAULT_THREAD_ID=0;// Counters used to generate unique IDs.
...
console.info('%cDownload the React DevTools '+'for a better development experience: '+'https://reactjs.org/link/react-devtools'+(protocol==='file:'?'\nYou might need to use a local HTTP server (instead of file://): '+'https://reactjs.org/link/react-devtools-faq':''),'font-weight:bold');}}}}exports.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Internals;exports.createPortal=createPortal$1;exports.findDOMNode=findDOMNode;exports.flushSync=flushSync;exports.hydrate=hydrate;exports.render=render;exports.unmountComponentAtNode=unmountComponentAtNode;exports.unstable_batchedUpdates=batchedUpdates$1;exports.unstable_createPortal=unstable_createPortal;exports.unstable_renderSubtreeIntoContainer=renderSubtreeIntoContainer;exports.version=ReactVersion;})();}},{"react":"node_modules/react/index.js","object-assign":"node_modules/object-assign/index.js","scheduler":"node_modules/scheduler/index.js","scheduler/tracing":"node_modules/scheduler/tracing.js"}],"node_modules/react-dom/index.js":[function(require,module,exports){'use strict';function checkDCE(){/* global __REACT_DEVTOOLS_GLOBAL_HOOK__ */if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__==='undefined'||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!=='function'){return;}if("development"!=='production'){// This branch is unreachable because this function is only called
...
console.error(err);}}if("development"==='production'){// DCE check should happen before ReactDOM bundle executes so that
// DevTools can report bad minification during injection.
checkDCE();module.exports=require('./cjs/react-dom.production.min.js.js');}else{module.exports=require('./cjs/react-dom.development.js.js');}},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"Components/useVariables.js":[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports["default"]=useVariable;var _react=require("react");function useVariable(){var endpoint="https://restcountries.eu/rest/v2/all";var _ref2=(0,_react.useState)([]),_ref3=_slicedToArray(_ref2,2),countries=_ref3[0],setCountries=_ref3[1];var _ref4=(0,_react.useState)(true),_ref5=_slicedToArray(_ref4,2),showQuestions=_ref5[0],setShowQuestions=_ref5[1];var _ref6=(0,_react.useState)("btn"),_ref7=_slicedToArray(_ref6,2),answerButtonClass=_ref7[0],setAnswerButtonClass=_ref7[1];var _ref8=(0,_react.useState)(false),_ref9=_slicedToArray(_ref8,2),disableButton=_ref9[0],setDisableButton=_ref9[1];var _ref10=(0,_react.useState)(0),_ref11=_slicedToArray(_ref10,2),scores=_ref11[0],setScores=_ref11[1];// Fetch the countries
function fetchCountries(){var response,countryData;return regeneratorRuntime.async(function fetchCountries$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.next=2;return regeneratorRuntime.awrap(fetch(endpoint));case 2:response=_context.sent;_context.next=5;return regeneratorRuntime.awrap(response.json());case 5:countryData=_context.sent;setCountries(countryData);case 7:case"end":return _context.stop();}}});}(0,_react.useEffect)(function(){fetchCountries();},[]);// Calculate the scores
var handleIncrement=function handleIncrement(){setScores(function(prevScores){return prevScores+1;});};// Get different random numbers from the array of countries 
var randomNumber1=Math.floor(Math.random()*countries.length);var randomNumber2=Math.floor(Math.random()*countries.length);var randomNumber3=Math.floor(Math.random()*countries.length);var randomNumber4=Math.floor(Math.random()*countries.length);return{fetchCountries:fetchCountries,countries:countries,setCountries:setCountries,showQuestions:showQuestions,setShowQuestions:setShowQuestions,answerButtonClass:answerButtonClass,setAnswerButtonClass:setAnswerButtonClass,disableButton:disableButton,setDisableButton:setDisableButton,randomNumber1:randomNumber1,randomNumber2:randomNumber2,randomNumber3:randomNumber3,randomNumber4:randomNumber4,scores:scores,setScores:setScores,handleIncrement:handleIncrement};}},{"react":"node_modules/react/index.js"}],"assets/highlight_off.svg":[function(require,module,exports){module.exports="/highlight_off.3b6aea7e.svg";},{}],"assets/check_circle_outline.svg":[function(require,module,exports){module.exports="/check_circle_outline.3e1d2887.svg";},{}],"Components/useButtonStyles.js":[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports["default"]=useButtonsStyles;var _highlight_off=_interopRequireDefault(require("../assets/highlight_off.svg"));var _check_circle_outline=_interopRequireDefault(require("../assets/check_circle_outline.svg"));function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj};}function useButtonsStyles(){// Style for the button if the user clicks the wrong answer 
function wrongAnswerButtonStyles(e){var buttonStyle=e.currentTarget.style;buttonStyle.backgroundColor="#EA8282";buttonStyle.backgroundImage="url(".concat(_highlight_off["default"],")");buttonStyle.backgroundRepeat="no-repeat";buttonStyle.backgroundPosition="98%";buttonStyle.color="#FFFFFF";};// Style for the button if the user clicks the right answer 
function rightAnswerButtonStyles(rightButton){var buttonStyle=rightButton.style;buttonStyle.backgroundColor="#60BF88";buttonStyle.backgroundImage="url(".concat(_check_circle_outline["default"],")");buttonStyle.backgroundRepeat="no-repeat";buttonStyle.backgroundPosition="98%";buttonStyle.color="#FFFFFF";};return{wrongAnswerButtonStyles:wrongAnswerButtonStyles,rightAnswerButtonStyles:rightAnswerButtonStyles};}},{"../assets/highlight_off.svg":"assets/highlight_off.svg","../assets/check_circle_outline.svg":"assets/check_circle_outline.svg"}],"Components/useQuestions.js":[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports["default"]=useQuestions;function useQuestions(){// Choose the country function
var chooseCountryFunction=function chooseCountryFunction(e,countryNameRightAnswer,setShowQuestions){// Get the id of the button that is being clicked
var buttonId=e.currentTarget.id;e.currentTarget.style.color="white";//Call the function that has styles for the button that has the right answer 
if(buttonId===countryNameRightAnswer){// Display the next button
var nextButton=document.getElementById("next-btn-container");nextButton.style.display="block";setShowQuestions(true);}else{setTimeout(function(){setShowQuestions(false);},1000);}};// A function that made for changing the questions
var changeTheQuestion=function changeTheQuestion(fetchCountries,handleIncrement,wrongAnswerButtonStyles){var nextButton=document.getElementById("next-btn-container");// display the next button
nextButton.style.display="none";//Remove the button's background after clicking the next-button
var buttonsArray=document.getElementsByClassName("btn");for(var i=0;i<buttonsArray.length;i++){var eachButton=buttonsArray[i];// Reset the background to its original bg
eachButton.style.backgroundColor="white";eachButton.style.color="rgba(96, 102, 208, 0.8)";}fetchCountries();handleIncrement();};return{chooseCountryFunction:chooseCountryFunction,changeTheQuestion:changeTheQuestion};}},{}],"Components/Header.js":[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports["default"]=Header;var _react=_interopRequireDefault(require("react"));function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj};}function Header(){return(/*#__PURE__*/_react["default"].createElement("header",null,/*#__PURE__*/_react["default"].createElement("h1",{className:"page--title"},"Country Quiz")));}},{"react":"node_modules/react/index.js"}],"Components/Questions/Questions.js":[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports["default"]=Questions;var _react=_interopRequireDefault(require("react"));function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj};}function Questions(props){return(/*#__PURE__*/_react["default"].createElement("div",{className:"questions--container"},props.flag?/*#__PURE__*/_react["default"].createElement("img",{src:props.flag,alt:"flag"}):"",/*#__PURE__*/_react["default"].createElement("h2",null,props.question),/*#__PURE__*/_react["default"].createElement("div",{className:"countries--container"},/*#__PURE__*/_react["default"].createElement("button",{type:"button",id:props.countriesToShow1,className:props.buttonClass,onClick:props.handleClick,disabled:props.isDisabed},/*#__PURE__*/_react["default"].createElement("span",{className:"buttonText"},"A")," ",/*#__PURE__*/_react["default"].createElement("span",{className:"buttonText"},props.countriesToShow1)),/*#__PURE__*/_react["default"].createElement("button",{type:"button",id:props.countriesToShow2,className:props.buttonClass,onClick:props.handleClick,disabled:props.isDisabed},/*#__PURE__*/_react["default"].createElement("span",{className:"buttonText"},"B")," ",/*#__PURE__*/_react["default"].createElement("span",{className:"buttonText"},props.countriesToShow2)),/*#__PURE__*/_react["default"].createElement("button",{type:"button",id:props.countriesToShow3,className:props.buttonClass,onClick:props.handleClick,disabled:props.isDisabed},/*#__PURE__*/_react["default"].createElement("span",{className:"buttonText"},"C")," ",/*#__PURE__*/_react["default"].createElement("span",{className:"buttonText"},props.countriesToShow3)),/*#__PURE__*/_react["default"].createElement("button",{type:"button",id:props.countriesToShow4,className:props.buttonClass,onClick:props.handleClick,disabled:props.isDisabed},/*#__PURE__*/_react["default"].createElement("span",{className:"buttonText"},"D")," ",/*#__PURE__*/_react["default"].createElement("span",{className:"buttonText"},props.countriesToShow4)),/*#__PURE__*/_react["default"].createElement("div",{className:"next-btn-container",id:"next-btn-container"},/*#__PURE__*/_react["default"].createElement("button",{type:"button",className:"next-button",id:"nextBtn",onClick:props.changeTheQuestion}," Next ")))));}},{"react":"node_modules/react/index.js"}],"Components/Scores.js":[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports["default"]=Scores;var _react=_interopRequireDefault(require("react"));function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj};}function Scores(props){return(/*#__PURE__*/_react["default"].createElement("div",{className:"scores--container"},/*#__PURE__*/_react["default"].createElement("h2",{className:"page--subheading"},"Results"),/*#__PURE__*/_react["default"].createElement("p",null,"You got ",/*#__PURE__*/_react["default"].createElement("span",{className:"score--number"},props.scores)," correct answers"),/*#__PURE__*/_react["default"].createElement("button",{type:"button",className:"return--btn",id:"return--btn",onClick:props.resetQuiz},"Try again")));}},{"react":"node_modules/react/index.js"}],"App.js":[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports["default"]=App;var _react=_interopRequireDefault(require("react"));var _useVariables=_interopRequireDefault(require("./Components/useVariables"));var _useButtonStyles=_interopRequireDefault(require("./Components/useButtonStyles"));var _useQuestions=_interopRequireDefault(require("./Components/useQuestions"));var _Header=_interopRequireDefault(require("./Components/Header"));var _Questions=_interopRequireDefault(require("./Components/Questions/Questions"));var _Scores=_interopRequireDefault(require("./Components/Scores"));function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj};}function App(){var _ref12=(0,_useVariables["default"])(),fetchCountries=_ref12.fetchCountries,showQuestions=_ref12.showQuestions,setShowQuestions=_ref12.setShowQuestions,countries=_ref12.countries,answerButtonClass=_ref12.answerButtonClass,disableButton=_ref12.disableButton,setDisableButton=_ref12.setDisableButton,randomNumber1=_ref12.randomNumber1,randomNumber2=_ref12.randomNumber2,randomNumber3=_ref12.randomNumber3,randomNumber4=_ref12.randomNumber4,scores=_ref12.scores,setScores=_ref12.setScores,handleIncrement=_ref12.handleIncrement;var _ref13=(0,_useQuestions["default"])(),chooseCountryFunction=_ref13.chooseCountryFunction,changeTheQuestion=_ref13.changeTheQuestion;var _ref14=(0,_useButtonStyles["default"])(),wrongAnswerButtonStyles=_ref14.wrongAnswerButtonStyles,rightAnswerButtonStyles=_ref14.rightAnswerButtonStyles;var capitalName;var countryNameRightAnswer;var flagToShow;var flagCountryOwner;// Get all the capitals from the data 
var capitalArr=countries.map(function(country){return country.capital;});// Get all the country names from the data
var countryNameArr=countries.map(function(country){return country.name;});// This is how we look foor the right country that matches the question
var findCountryAnswer=countries.find(function(country){return country.capital==capitalArr[randomNumber1];});if(findCountryAnswer){capitalName=findCountryAnswer.capital;countryNameRightAnswer=findCountryAnswer.name;}else{return null;}// Get one flag from the data
var flagsArr=countries.map(function(country){return country.flag;});// Finding the owner of the flag
var findFlagOwner=countries.find(function(country){return country.flag==flagsArr[randomNumber1];});// if the flagOwner object exists, get flag and the flag owner
if(findFlagOwner){flagToShow=findFlagOwner.flag;flagCountryOwner=findFlagOwner.name;}else{return null;}// All the countries to show in the quiz including the right answer
// Random Index from the countryName array for the countries to show array
var countriesToShowArr=[countryNameRightAnswer,countryNameArr[randomNumber2],countryNameArr[randomNumber3],countryNameArr[randomNumber4]];// Randomize countries to show: change the order of the index in the array
var randomCountriesArr=countriesToShowArr,randomCountries=[],i=countriesToShowArr.length,j=0;// Disordering the index in the countries to show array randomly
while(i--){j=Math.floor(Math.random()*(i+1));randomCountries.push(randomCountriesArr[j]);randomCountriesArr.splice(j,1);}// A function that  for each button
var selectOneCountry=function selectOneCountry(e){var rightAnswerId=document.getElementById(countryNameRightAnswer);// calls the chooseCountry function in useQuestion file
chooseCountryFunction(e,countryNameRightAnswer,setShowQuestions,wrongAnswerButtonStyles(e),rightAnswerButtonStyles(rightAnswerId));};// Togglling between the two questions
var toggleQuestions=function toggleQuestions(){// call the changeQuestions function in useQuestion file that changes the questions here
changeTheQuestion(fetchCountries,handleIncrement);};// An object for the two different questions
var questions=[{question:"".concat(capitalName," is the capital of"),countryName1:randomCountries[0],countryName2:randomCountries[1],countryName3:randomCountries[2],countryName4:randomCountries[3]},{question:"Which country does this flag belong to?",countryName1:randomCountries[0],countryName2:randomCountries[1],countryName3:randomCountries[2],countryName4:randomCountries[3],flag:flagToShow}];// Random number to get a question randomy from the questions obj
var randomNumber=Math.floor(Math.random()*questions.length);var oneQuestion=questions[randomNumber];// Reset the quiz when clicking the try again btn
var resetQuizFunction=function resetQuizFunction(){setShowQuestions(true);setDisableButton(false);setScores(0);};return(/*#__PURE__*/_react["default"].createElement("div",null,/*#__PURE__*/_react["default"].createElement(_Header["default"],null),showQuestions?/*#__PURE__*/_react["default"].createElement(_Questions["default"],{flag:oneQuestion.flag,question:oneQuestion.question,countriesToShow1:oneQuestion.countryName1,countriesToShow2:oneQuestion.countryName2,countriesToShow3:oneQuestion.countryName3,countriesToShow4:oneQuestion.countryName4,buttonClass:answerButtonClass,isDisabed:disableButton,handleClick:function handleClick(e){return selectOneCountry(e);},changeTheQuestion:toggleQuestions}):/*#__PURE__*/_react["default"].createElement(_Scores["default"],{scores:scores,resetQuiz:resetQuizFunction})));}},{"react":"node_modules/react/index.js","./Components/useVariables":"Components/useVariables.js","./Components/useButtonStyles":"Components/useButtonStyles.js","./Components/useQuestions":"Components/useQuestions.js","./Components/Header":"Components/Header.js","./Components/Questions/Questions":"Components/Questions/Questions.js","./Components/Scores":"Components/Scores.js"}],"index.js":[function(require,module,exports){"use strict";var _react=_interopRequireDefault(require("react"));var _reactDom=_interopRequireDefault(require("react-dom"));var _App=_interopRequireDefault(require("./App"));function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj};}_reactDom["default"].render(/*#__PURE__*/_react["default"].createElement(_App["default"],null),document.getElementById("root"));},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./App":"App.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports){var global=arguments[3];var OVERLAY_ID='__parcel__error__overlay__';var OldModule=module.bundle.Module;function Module(moduleName){OldModule.call(this,moduleName);this.hot={data:module.bundle.hotData,_acceptCallbacks:[],_disposeCallbacks:[],accept:function accept(fn){this._acceptCallbacks.push(fn||function(){});},dispose:function dispose(fn){this._disposeCallbacks.push(fn);}};module.bundle.hotData=null;}module.bundle.Module=Module;var checkedAssets,assetsToAccept;var parent=module.bundle.parent;if((!parent||!parent.isParcelRequire)&&typeof WebSocket!=='undefined'){var hostname=""||location.hostname;var protocol=location.protocol==='https:'?'wss':'ws';var ws=new WebSocket(protocol+'://'+hostname+':'+"52924"+'/');ws.onmessage=function(event){checkedAssets={};assetsToAccept=[];var data=JSON.parse(event.data);if(data.type==='update'){var handled=false;data.assets.forEach(function(asset){if(!asset.isNew){var didAccept=hmrAcceptCheck(global.parcelRequire,asset.id);if(didAccept){handled=true;}}});// Enable HMR for CSS by default.
handled=handled||data.assets.every(function(asset){return asset.type==='css'&&asset.generated.js;});if(handled){console.clear();data.assets.forEach(function(asset){hmrApply(global.parcelRequire,asset);});assetsToAccept.forEach(function(v){hmrAcceptRun(v[0],v[1]);});}else if(location.reload){// `location` global exists in a web worker context but lacks `.reload()` function.
location.reload();}}if(data.type==='reload'){ws.close();ws.onclose=function(){location.reload();};}if(data.type==='error-resolved'){console.log('[parcel] ✨ Error resolved');removeErrorOverlay();}if(data.type==='error'){console.error('[parcel] 🚨  '+data.error.message+'\n'+data.error.stack);removeErrorOverlay();var overlay=createErrorOverlay(data);document.body.appendChild(overlay);}};}function removeErrorOverlay(){var overlay=document.getElementById(OVERLAY_ID);if(overlay){overlay.remove();}}function createErrorOverlay(data){var overlay=document.createElement('div');overlay.id=OVERLAY_ID;// html encode message and stack trace
var message=document.createElement('div');var stackTrace=document.createElement('pre');message.innerText=data.error.message;stackTrace.innerText=data.error.stack;overlay.innerHTML='<div style="background: black; font-size: 16px; color: white; position: fixed; height: 100%; width: 100%; top: 0px; left: 0px; padding: 30px; opacity: 0.85; font-family: Menlo, Consolas, monospace; z-index: 9999;">'+'<span style="background: red; padding: 2px 4px; border-radius: 2px;">ERROR</span>'+'<span style="top: 2px; margin-left: 5px; position: relative;">🚨</span>'+'<div style="font-size: 18px; font-weight: bold; margin-top: 20px;">'+message.innerHTML+'</div>'+'<pre>'+stackTrace.innerHTML+'</pre>'+'</div>';return overlay;}function getParents(bundle,id){var modules=bundle.modules;if(!modules){return[];}var parents=[];var k,d,dep;for(k in modules){for(d in modules[k][1]){dep=modules[k][1][d];if(dep===id||Array.isArray(dep)&&dep[dep.length-1]===id){parents.push(k);}}}if(bundle.parent){parents=parents.concat(getParents(bundle.parent,id));}return parents;}function hmrApply(bundle,asset){var modules=bundle.modules;if(!modules){return;}if(modules[asset.id]||!bundle.parent){var fn=new Function('require','module','exports',asset.generated.js);asset.isNew=!modules[asset.id];modules[asset.id]=[fn,asset.deps];}else if(bundle.parent){hmrApply(bundle.parent,asset);}}function hmrAcceptCheck(bundle,id){var modules=bundle.modules;if(!modules){return;}if(!modules[id]&&bundle.parent){return hmrAcceptCheck(bundle.parent,id);}if(checkedAssets[id]){return;}checkedAssets[id]=true;var cached=bundle.cache[id];assetsToAccept.push([bundle,id]);if(cached&&cached.hot&&cached.hot._acceptCallbacks.length){return true;}return getParents(global.parcelRequire,id).some(function(id){return hmrAcceptCheck(global.parcelRequire,id);});}function hmrAcceptRun(bundle,id){var cached=bundle.cache[id];bundle.hotData={};if(cached){cached.hot.data=bundle.hotData;}if(cached&&cached.hot&&cached.hot._disposeCallbacks.length){cached.hot._disposeCallbacks.forEach(function(cb){cb(bundle.hotData);});}delete bundle.cache[id];bundle(id);cached=bundle.cache[id];if(cached&&cached.hot&&cached.hot._acceptCallbacks.length){cached.hot._acceptCallbacks.forEach(function(cb){cb();});return true;}}},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"],null);